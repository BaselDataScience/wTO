#' @title Cut.off
#' @description Computes the cutoff threshold using the descriptive values generated
#'  by the bootstrap, also plots the empirical distribution and the sample wTO.
